...
- ASP, the session protocol used for participant-to-Room and Room-to-Room communication
- workspace lifecycle, routing, audit logging, federation, and open specification questions
