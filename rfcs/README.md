...
This directory holds protocol design notes that are more focused than the broad
draft in `agent-workspace.md` and more stable than scratch implementation
journal entries in the workspace repo.
